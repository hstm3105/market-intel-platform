...
import { summarizePortfolio } from "./portfolioIntelligence";
...
describe("portfolio intelligence metrics", () => {
  it("aggregates source confidence, high-risk concentration, industry coverage, and shared risk themes deterministically", () => {
